...
`content` の下を GitHub に push すると自動で GitHub Actions　によりサイトに反映されます。反映には数十秒かかります。
...
ローカルでプレビューするには Hugo が必要です。インストールの手順は [公式サイト](https://gohugo.io/installation/) を参照してください。
